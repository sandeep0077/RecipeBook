...
export class RecipeListComponent implements OnInit {
  ...
  recipes : Recipe[] = [
    ...
    new Recipe("A tet Recipe","This is first Recipe test", "https://images.unsplash.com/photo-1505253716362-afaea1d3d1af?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80")
  ]
